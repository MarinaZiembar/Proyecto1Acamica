...
class Map extends React.Component{
    ...
    render(){
        ...
        const{fentrada, fsalida, pais, precio, tamaño, click}=this.state
        ...
        //Logica de puntos en el mapa y tarjetas a partir de filtros
        let array=[1,2,3,4];
